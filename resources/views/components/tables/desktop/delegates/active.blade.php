<div class="hidden w-full table-container md:block">
    <table>
        <thead>
            <tr>
                <x-tables.headers.desktop.text name="general.delegates.rank" on-click="$emit('orderDelegatesBy', '{{ OrderingTypeEnum::RANK }}')" :sorting-direction="$this->delegatesOrderingDirection" />
