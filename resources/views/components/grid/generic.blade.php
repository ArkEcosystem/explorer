...
@else
<div class="flex items-center justify-between pb-4 border-b border-theme-secondary-300 dark:border-theme-secondary-800 {{ $responsiveBorder ?? false ? 'md:border-none' : '' }}">
@endif
