...
<div class="entity-header-item {{ $wrapperClass }}">
    @unless($withoutIcon)
    ...
    <div class="flex flex-col flex-1 justify-between font-semibold space-y-2 p-1 -m-1 {{ $contentClass }}{{ $truncate ? ' truncate' : '' }}">
