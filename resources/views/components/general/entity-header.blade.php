<div class="flex flex-col border-2 rounded-xl border-theme-secondary-300 dark:border-theme-secondary-800">
    <div class="px-8 py-6 bg-black dark:bg-theme-secondary-900 @if (isset($bottom)) rounded-t-xl @else rounded-xl @endif">
        <div class="flex flex-col overflow-auto {{ $isBlockPage ?? false ? 'md:flex-row' : 'space-y-8 lg:flex-row' }} lg:space-y-0 justify-between">
    ...
    @isset($bottom)
        <div class="px-8 py-4 border-t rounded-b-xl bg-theme-secondary-100 border-theme-secondary-300 dark:border-theme-secondary-800 dark:bg-theme-secondary-900">
            {{ $bottom }}
        </div>
    @endisset
</div>
