<div class="flex flex-col border-2 rounded-lg border-theme-secondary-300 dark:border-theme-secondary-800">
    ...
    @isset($bottom)
        <div class="px-8 py-4 border-t rounded-b-lg bg-theme-secondary-100 border-theme-secondary-300 dark:border-theme-secondary-800 dark:bg-theme-secondary-900">
            {{ $bottom }}
        </div>
    @endisset
</div>
