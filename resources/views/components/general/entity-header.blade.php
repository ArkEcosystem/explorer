<div class="flex flex-col rounded-lg border-2 border-theme-secondary-300 dark:border-theme-secondary-800">
    ...
    @isset($bottom)
        <div class="py-4 px-8 rounded-b-lg border-t bg-theme-secondary-100 border-theme-secondary-300 dark:border-theme-secondary-800 dark:bg-theme-secondary-900">
            {{ $bottom }}
        </div>
    @endisset
</div>
