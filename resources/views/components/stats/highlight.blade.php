...
<x-general.card class="flex flex-shrink-0 items-center space-x-3 min-w-80 sm:min-w-60">
    <x-ark-icon :name="$icon" size="xl" class="text-theme-secondary-900 dark:text-theme-secondary-600" />

    <div class="flex flex-col">
        <h2 class="text-sm font-semibold text-theme-secondary-500 dark:text-theme-secondary-700">{{ $title }}</h2>
