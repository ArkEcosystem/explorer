<div x-data="{ publicKeyModalVisible: false }" class="flex-1 lg:relative">
    ...
    <div @click.away="publicKeyModalVisible = false" x-show="publicKeyModalVisible" class="absolute left-0 right-0 z-10 w-auto mx-8 mt-4 bg-white rounded-lg shadow-lg lg:left-auto lg:mx-0 dark:shadow-header-smooth-dark dark:bg-theme-secondary-900" x-cloak>
