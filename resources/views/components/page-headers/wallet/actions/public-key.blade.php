<div x-data="{ publicKeyModalVisible: false }" class="flex-1 w-full mt-4 sm:w-auto sm:mt-0">
    ...
    <div @click.away="publicKeyModalVisible = false" x-show="publicKeyModalVisible" class="absolute left-0 right-0 z-10 w-auto mx-8 mt-4 bg-white shadow-lg rounded-xl lg:mt-1 lg:mx-0 lg:left-auto lg:mr-32 dark:shadow-lg-dark dark:bg-theme-secondary-900" x-cloak>
