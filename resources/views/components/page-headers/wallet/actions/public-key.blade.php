<div x-data="{ publicKeyModalVisible: false }" class="flex-1 mt-4 w-full sm:w-auto sm:mt-0">
    ...
    <div @click.away="publicKeyModalVisible = false" x-show="publicKeyModalVisible" class="absolute right-0 left-0 z-10 mx-8 w-auto bg-white rounded-lg shadow-lg lg:mx-0 lg:left-auto lg:mr-36 dark:shadow-lg-dark dark:bg-theme-secondary-900" x-cloak>
