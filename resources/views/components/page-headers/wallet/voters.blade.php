<x-page-headers.wallet.frame title="pages.voters_by_wallet.title" :wallet="$wallet">
    ...
    <x-page-headers.wallet.frame-item icon="app-transactions.confirmed-vote" :title="trans('pages.wallet.delegate.votes_percentage', [number_format($wallet->votesPercentage(), 2)])">
