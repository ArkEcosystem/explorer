<x-general.search.advanced-option :title="trans('forms.search.height_range')" type="block">
...
<x-general.search.advanced-option :title="trans('forms.search.total_amount_range')" type="block">
    <div class="flex items-center space-x-2">
        <div class="flex-1">
            <input
                type="number"
...
<x-general.search.advanced-option :title="trans('forms.search.total_fee_range')" type="block">
    <div class="flex items-center space-x-2">
        <div class="flex-1">
            <input
                type="number"
