    ...
    <x-slot name="dropdownEntry">
        <div class="flex justify-between items-center w-full font-semibold md:justify-end md:space-x-2 text-theme-secondary-500 md:text-theme-secondary-700">
            <div>
                ...
                <span
                    x-text="text"
                    class="whitespace-nowrap text-theme-secondary-900 dark:text-theme-secondary-200 md:text-theme-secondary-700"
                ></span>
            </div>

            <span
                :class="{ 'rotate-180 md:bg-theme-primary-600 md:text-theme-secondary-100': open }"
                class="flex absolute right-0 justify-center items-center mr-4 w-6 h-6 rounded-full transition duration-150 ease-in-out md:relative md:mr-0 md:w-4 md:h-4 text-theme-secondary-400 dark:bg-theme-secondary-800 dark:text-theme-secondary-200 md:bg-theme-primary-100 md:text-theme-primary-600"
            >
