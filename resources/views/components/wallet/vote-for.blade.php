<div class="w-full pb-8 bg-white content-container dark:bg-theme-secondary-900">
            ...
            <div class="flex space-x-8 sm:space-x-4">
                @if(! $vote->isResigned())
                    <x-general.entity-header-item
                        ...
                        without-icon
                        content-class="space-y-2 border-r pr-7 sm:pr-0 sm:text-right sm:border-r-0 border-theme-secondary-300 dark:border-theme-secondary-800"
                    >
                        <x-slot name="text">
                            @if ($vote->isResigned())
                                <x-details.resigned />
