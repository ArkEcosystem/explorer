<div x-data="{ publicKeyModalVisible: false }" class="relative">
    ...
    <div @click.away="publicKeyModalVisible = false" x-show="publicKeyModalVisible" class="absolute right-0 z-40 mt-4 bg-white rounded-lg shadow-lg dark:bg-theme-secondary-900 w-128" x-cloak>
