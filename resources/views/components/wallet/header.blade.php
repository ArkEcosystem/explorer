<div class="dark:bg-theme-secondary-900">
    <div class="flex-col pt-16 mb-16 space-y-6 content-container">
        ...
        >
            ...
            <x-slot name="extra">
                <div class="flex flex-row flex-1 pl-4 space-x-4 font-semibold border-l md:ml-8 border-theme-secondary-800">
                ...
                <div class="flex items-center mt-6 space-x-2 text-theme-secondary-200 md:mt-0">
                    ...
                    <a href="#" class="flex items-center justify-center flex-1 w-16 px-3 rounded cursor-pointer bg-theme-secondary-800 hover:bg-theme-primary-600 transition-default md:flex-none h-11">
                        @svg('app-key', 'w-6 h-6')
                    </a>

                    <button @click="livewire.emit('toggleQrCode')" type="button" class="flex items-center justify-center flex-1 w-16 px-3 rounded cursor-pointer bg-theme-primary-600 hover:bg-theme-primary-600 transition-default md:flex-none h-11">
