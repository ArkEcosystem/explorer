...
>
    ...
    <div class="flex space-x-3">
        ...
        <div class="relative">
            <form x-show="search" name="searchForm" type="get" class="absolute left-0 z-10 flex w-full h-full px-2 overflow-hidden rounded bg-theme-primary-100 pagination-form-desktop dark:bg-theme-secondary-800">
                <input
                    x-ref="search"
                    x-model.number="page"
                    type="number"
