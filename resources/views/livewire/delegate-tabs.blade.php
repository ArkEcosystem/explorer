<div class="hidden justify-between mb-4 space-x-6 md:flex">
    ...
    <div class="relative z-10 w-3/12 text-center bg-theme-secondary-100 rounded-xl dark:bg-black lg:w-2/12">
        <button
            type="button"
            class="flex relative font-semibold justify-center items-center px-2 w-full cursor-pointer transition-default hover:text-theme-secondary-900 dark:hover:text-theme-secondary-200"
