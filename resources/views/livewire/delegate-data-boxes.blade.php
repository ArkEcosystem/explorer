@if(! count($statistics))
    <div wire:poll="pollStatistics" wire:key="poll_statistics_skeleton">
        <div class="flex w-full md:flex-col xl:flex-row md:space-y-4 xl:space-y-0 xl:space-x-4">
            <div class="flex flex-row py-3 px-6 bg-white dark:dark:bg-theme-secondary-900 rounded-xl">
                <div class="flex lg:w-1/2 xl:w-full space-x-4">
                    <div class="flex flex-grow rounded-xl dark:bg-theme-secondary-900">
                        <div class="circled-icon h-11 rounded-xl border-theme-secondary-300 bg-theme-secondary-100"></div>
                        <div class="flex flex-col ml-4 justify-between">
                            <div class="h-2 w-24 bg-theme-secondary-100"></div>
                            <div class="h-2 w-24 bg-theme-secondary-100"></div>
                        </div>
                    </div>
...
@else
    <div id="statistics-list" class="w-full" wire:poll.{{ Network::blockTime() }}s="pollStatistics" wire:key="poll_statistics_real">
        <div class="flex w-full md:flex-col xl:flex-row md:space-y-4 xl:space-y-0 xl:space-x-4">
            ...
            <div class="flex flex-row py-3 px-6 bg-white dark:bg-theme-secondary-900 rounded-xl">
