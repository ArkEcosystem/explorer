<div class="flex-1 w-full sm:w-auto">
    ...
    <button
        ...
        type="button"
        class="flex flex-1 justify-center items-center w-full h-11 rounded cursor-pointer lg:flex-none lg:px-3 lg:w-16 bg-theme-primary-600 hover:bg-theme-primary-700 transition-default"
    >
