...
final class NetworkStatusBlockCache implements Contract
{
    ...
    public function getHistoricalHourly(string $source, string $target): Collection|null
    {
        return $this->get(sprintf('historical-hourly/%s/%s', $source, $target));
    }

    public function setHistoricalHourly(string $source, string $target, ?Collection $historical): Collection|null
    {
    ...
    public function getPrice(string $source, string $target): float|null
    {
    ...
    public function setPrice(string $source, string $target, ?float $price): float|null
    {
    ...
    public function getPriceChange(string $source, string $target): float|null
    {
    ...
    public function setPriceChange(string $source, string $target, ?float $priceChange): float|null
    {
