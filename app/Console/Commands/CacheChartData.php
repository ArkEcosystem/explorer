...
final class CacheChartData extends Command
{
    ...
    private function cacheFees(): void
    {
        ...
        $this->cacheKeyValue('chart.fees.day', $fees->aggregate(Carbon::now()->subDay(), $today, 'H:s'), 'H:s');
        $this->cacheKeyValue('chart.fees.week', $fees->aggregate(Carbon::now()->subDays(7), $today, 'd.m'), 'd.m');
        $this->cacheKeyValue('chart.fees.month', $fees->aggregate(Carbon::now()->subDays(30), $today, 'd.m'), 'd.m');
        $this->cacheKeyValue('chart.fees.quarter', $fees->aggregate(Carbon::now()->subDays(120), $today, 'W'), 'W');
        $this->cacheKeyValue('chart.fees.year', $fees->aggregate(Carbon::now()->subDays(365), $today, 'M'), 'M');
    }
