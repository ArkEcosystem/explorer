...
final class MonitorStatistics extends Component
{
    ...
    {
        return Cache::remember('delegateRegistrations', Network::blockTime(), function () {
    ...
    {
        return Cache::remember('feesCollected', Network::blockTime(), function () {
    ...
    {
        return Cache::remember('votes', Network::blockTime(), function () {
    ...
    {
        return Cache::remember('votesPercentage', Network::blockTime(), function () {
