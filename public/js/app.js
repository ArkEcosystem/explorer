...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _ui_js_tippy_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @ui/js/tippy.js */ "./vendor/arkecosystem/ui/resources/assets/js/tippy.js");
/* harmony import */ var _ui_js_page_scroll__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @ui/js/page-scroll */ "./vendor/arkecosystem/ui/resources/assets/js/page-scroll.js");
/* harmony import */ var _ui_js_page_scroll__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_ui_js_page_scroll__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _ui_js_pagination__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @ui/js/pagination */ "./vendor/arkecosystem/ui/resources/assets/js/pagination.js");
/* harmony import */ var _ui_js_modal__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @ui/js/modal */ "./vendor/arkecosystem/ui/resources/assets/js/modal.js");
/* harmony import */ var _ui_js_rich_select_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @ui/js/rich-select.js */ "./vendor/arkecosystem/ui/resources/assets/js/rich-select.js");
...
window.Pagination = _ui_js_pagination__WEBPACK_IMPORTED_MODULE_2__["default"];
window.Modal = _ui_js_modal__WEBPACK_IMPORTED_MODULE_3__["default"];
window.RichSelect = _ui_js_rich_select_js__WEBPACK_IMPORTED_MODULE_4__["default"];

/***/ }),

/***/ "./vendor/arkecosystem/ui/resources/assets/js/modal.js":
/*!*************************************************************!*\
  !*** ./vendor/arkecosystem/ui/resources/assets/js/modal.js ***!
  \*************************************************************/
/*! exports provided: default */
...
var onModalClosed = function onModalClosed(modal) {
...
var onModalOpened = function onModalOpened(modal) {
...
var Modal = {
  alpine: function alpine() {
    ...
    var modalName = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "";
      ...
      init: function init() {
        ...
        if (this.name) {
          Livewire.on("openModal", function (modalName) {
            if (_this.name === modalName) {
              _this.show();
            }
          });
        }

        this.$watch("shown", function (shown) {
          if (typeof _this.onBeforeShow === "function") {
            _this.onBeforeShow();
          }

          if (typeof _this.onBeforeHide === "function") {
            _this.onBeforeHide();
          }
  ...
  livewire: function livewire() {
    ...
    return _objectSpread({
      init: function init() {
        ...
        var modal = this.$refs.modal;
        this.$wire.on("modalClosed", function () {
...
/***/ "./vendor/arkecosystem/ui/resources/assets/js/page-scroll.js":
/*!*******************************************************************!*\
  !*** ./vendor/arkecosystem/ui/resources/assets/js/page-scroll.js ***!
  \*******************************************************************/
/*! no static exports found */
...
/***/ "./vendor/arkecosystem/ui/resources/assets/js/pagination.js":
/*!******************************************************************!*\
  !*** ./vendor/arkecosystem/ui/resources/assets/js/pagination.js ***!
  \******************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
var Pagination = function Pagination(pageName, lastPage) {
  return {
    search: false,
    page: null,
    init: function init() {
      ...
      this.$watch("search", function (search) {
        if (search) {
          _this.$nextTick(function () {
            var searchInputs = _this.$el.querySelectorAll("input[name=".concat(pageName, "]"));
...
/***/ "./vendor/arkecosystem/ui/resources/assets/js/rich-select.js":
/*!*******************************************************************!*\
  !*** ./vendor/arkecosystem/ui/resources/assets/js/rich-select.js ***!
  \*******************************************************************/
/*! exports provided: default */
...
var RichSelect = function RichSelect() {
  var extraData = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
  var options = arguments.length > 1 ? arguments[1] : undefined;
  var initialValue = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : "";
  var initialText = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : "";
  var grouped = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : false;
  var dispatchEvent = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : undefined;
  return _objectSpread({
    options: options,
    onInput: function onInput($dispatch, $event) {
      if (dispatchEvent) {
    ...
    init: function init() {
      ...
      this.$nextTick(function () {
        if (grouped) {
          _this.optionsCount = Object.keys(_this.options).map(function (groupName) {
            return Object.keys(_this.options[groupName]);
          }).flat().length;
        } else {
          _this.optionsCount = Object.keys(_this.options).length;
        }
      });
    },
    optionsCount: null,
    ...
    choose: function choose(value) {
      var groupName = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
    ...
    setHiddenInputValue: function setHiddenInputValue(value) {
    ...
    scrollToSelectedOption: function scrollToSelectedOption() {
      var listbox = this.$refs.listbox;
      var option = listbox.querySelectorAll("[data-option]")[this.selected];
    ...
    getAllValues: function getAllValues() {
      ...
      return Object.keys(this.options).map(function (groupName) {
        return Object.keys(_this3.options[groupName]);
      }).flat();
    },
    getOptionIndex: function getOptionIndex(groupIndex, optionIndex) {
      var index = 0;

      for (var i = 0; i < groupIndex; i++) {
        var group = this.options[Object.keys(this.options)[i]];
...
/* harmony default export */ __webpack_exports__["default"] = (RichSelect);

/***/ }),

/***/ "./vendor/arkecosystem/ui/resources/assets/js/tippy.js":
/*!*************************************************************!*\
  !*** ./vendor/arkecosystem/ui/resources/assets/js/tippy.js ***!
  \*************************************************************/
/*! no exports provided */
...
Object(tippy_js__WEBPACK_IMPORTED_MODULE_0__["default"])("[data-tippy-hover]", {
  touch: "hold",
  trigger: "mouseenter",
  content: function content(reference) {
    return reference.dataset.tippyHover;
  },
  duration: 0
});
...
if (typeof Livewire !== "undefined") {
  Livewire.hook("message.processed", function (message, component) {
    Object(tippy_js__WEBPACK_IMPORTED_MODULE_0__["default"])(component.el.querySelectorAll("[data-tippy-content]"), {
      trigger: "mouseenter focus",
      duration: 0
    });
    Object(tippy_js__WEBPACK_IMPORTED_MODULE_0__["default"])(component.el.querySelectorAll("[data-tippy-hover]"), {
      touch: "hold",
      trigger: "mouseenter",
      content: function content(reference) {
        return reference.dataset.tippyHover;
...
__webpack_require__(/*! /Users/alfonso/Projects/ark/explorer.ark.io/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /Users/alfonso/Projects/ark/explorer.ark.io/resources/css/app.css */"./resources/css/app.css");
