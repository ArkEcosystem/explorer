...
Before access the Explorer you'll need to cache data that is accessed a lot. Run `php artisan horizon` and then `php artisan cache:all` and wait until it has finished.
